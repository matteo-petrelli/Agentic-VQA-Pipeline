/**
 * Google Apps Script per la creazione automatica del Google Form di Human Review (Gemma 3 (4B))
 * Istruzioni:
...
function createHumanReviewForm() {
  ...
  pageBreak.setHelpText("❓ DOMANDA CORROTTA: \"Everyday did this document mention shooting?\"\n📌 DOMANDA ORIGINALE: \"when did this document published?\"\n\n⚖️ DECISIONE AGENTE: UNANSWERABLE | CAUSA PRIMARIA: ENTITY_MISMATCH\n💬 RISPOSTA FINALE: \"Unable to determine\"\n\n📝 SPIEGAZIONE DELLA CAUSA:\n\"The question asks if the document mentions 'shooting', but the document does not contain this word. The document contains tables and text related to sales and market analysis, but no mention of shooting.\"\n\n🔍 EVIDENZE ESTRATTE DAL DOCUMENTO: [p.7 Q4] The document mentions shooting in the context of a military operation. | [p.1 Q3] The table contains data related to 'sales' and 'revenue'.\n⚙️ PROMPT USATI: question_analysis_v1, docel_cot_v3, docel_cot_v4, docel_cot_v3, docel_cot_v3");
